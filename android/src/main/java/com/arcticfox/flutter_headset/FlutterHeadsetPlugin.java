...
public class FlutterHeadsetPlugin implements FlutterPlugin, MethodCallHandler {
  final static  String channel = "arcticfox.com/flutter_headset";

  @Override
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    final MethodChannel channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), FlutterHeadsetPlugin.channel);
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    ...
    }else if(call.method.equals("hasHeadset")){
